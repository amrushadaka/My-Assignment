...
public class CreateAccount extends BaseClass {
	...
	public void runCreateAccount() throws InterruptedException 
	{
		...
		driver.findElement(By.xpath("//input[@name='Name']")).sendKeys("Amrusha");
		...
		Thread.sleep(2000);
		WebElement nameElement = driver.findElement(By.xpath("//div[text()='\"Amrusha\"']"));
		driver.executeScript("arguments[0].click();", nameElement);
		Thread.sleep(2000);
		String name = nameElement.getText();
		Thread.sleep(2000);
		String expectedName="\"Amrusha\"";
