...
//			Enter Opportunity name
			...
			name.sendKeys("Salesforce Automated by Amrusha");
...
//			click Save and VerifyOppurtunity Name"
			...
			WebElement message = driver.findElement(By.xpath("//div[text()='\"Salesforce Automated by Amrusha\"']"));
			driver.executeScript("arguments[0].click();", message);
			Thread.sleep(2000);
			String text2 = message.getText();
			System.out.println(text2);
			String expectedMessage="\"Salesforce Automated by Amrusha\"";
